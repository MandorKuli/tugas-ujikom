...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('content_title', 'Data Spp'); ?>
...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-spp')): ?>
...
<?php echo $__env->make('admin.spp.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MY BLOG LARA\EXPERIMEN\web-spp\resources\views/admin/spp/index.blade.php ENDPATH**/ ?>