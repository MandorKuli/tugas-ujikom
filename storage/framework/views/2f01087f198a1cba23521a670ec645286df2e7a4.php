...
$(function () {
  ...
  var table = $("#dataTable2").DataTable({
      ...
      serverSide: true,
      "responsive": true,
      ajax: "<?php echo e(route('admin-list.index')); ?>",
      columns: [
...
$("#store").on("submit", function(e) {
  e.preventDefault()
  $.ajax({
    url: "<?php echo e(route('admin-list.store')); ?>",
    method: "POST",
    data: $(this).serialize(),
...
</script><?php /**PATH C:\MY BLOG LARA\EXPERIMEN\web-spp\resources\views/admin/admin-list/ajax.blade.php ENDPATH**/ ?>