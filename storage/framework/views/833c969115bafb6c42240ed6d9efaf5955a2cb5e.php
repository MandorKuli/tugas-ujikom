...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?php echo e(asset('templates/backend/AdminLTE-3.1.0')); ?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
unset($__errorArgs, $__bag); ?>
      <form action="<?php echo e(route('login')); ?>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="" name="username" value="<?php echo e(@old('username')); ?>" required="" class="form-control" placeholder="Username">
...
<!-- AdminLTE App -->
<script src="<?php echo e(asset('templates/backend/AdminLTE-3.1.0')); ?>/dist/js/adminlte.min.js"></script>
</body>
</html>
<?php /**PATH C:\MY BLOG LARA\EXPERIMEN\web-spp\resources\views/auth/login.blade.php ENDPATH**/ ?>